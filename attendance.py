...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # backgorund image
        bg1=Image.open(r"GUI Images\bg2.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Attendance Panel",font=("verdana",30,"bold"),bg="black",fg="gray")
        title_lb1.place(x=0,y=0,width=1366,height=48)
        ...
        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("verdana",12,"bold"),fg="gray")
        ...
        #Student id
        studentId_label = Label(left_frame,text="Roll-ID:",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        #Student Roll
        student_roll_label = Label(left_frame,text="Name:",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        #Studnet Name
        student_name_label = Label(left_frame,text="Dep:",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        self.attendanceReport_left.heading("ID",text="Roll-ID")
        self.attendanceReport_left.heading("Roll_No",text="Name")
        self.attendanceReport_left.heading("Name",text="DEP")
        ...
        self.attendanceReport.heading("ID",text="Roll_ID")
        self.attendanceReport.heading("Roll_No",text="Name")
        self.attendanceReport.heading("Name",text="Dep")
        self.attendanceReport.heading("Time",text="Time")
        self.attendanceReport.heading("Date",text="Date")
        self.attendanceReport.heading("Attend",text="Attend_status")
        ...
        if self.var_id.get()=="" or self.var_roll.get=="" or self.var_name.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor.execute("update attend set roll.no=%s,std_name=%s,std_time=%s,std_date=%s,std_attendance=%s where std_id=%s",( 
        ...
        if self.var_id.get()=="":
            ...
            try:
                ...
                if delete>0:
                    conn = mysql.connector.connect(username='root', password='Krishnamkmk4422@',host='localhost',database='krish')
                    mycursor = conn.cursor() 
                    sql="delete from attend where std_id=%s"
                    val=(self.var_id.get(),)
    ...
    def action(self):
        if self.var_id.get()=="" or self.var_roll.get=="" or self.var_name.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                conn = mysql.connector.connect(username='root', password='Krishnamkmk4422@',host='localhost',database='krish')
                mycursor = conn.cursor()
                mycursor.execute("insert into attend values(%s,%s,%s,%s,%s,%s)",(
                self.var_id.get(),
                self.var_roll.get(),
                self.var_name.get(),
                self.var_time.get(),
    ...
    #     conn = mysql.connector.connect(username='root', password='Krish4422@',host='localhost',database='krish')
    #     mycursor = conn.cursor()
    ...
    #             udate = i[4]
    #             uattend = i[5]
    #             qury = "INSERT INTO attend(std_id, std_roll_no, std_name, std_time, std_date, std_attendance) VALUES(%s,%s,%s,%s,%s,%s)"
